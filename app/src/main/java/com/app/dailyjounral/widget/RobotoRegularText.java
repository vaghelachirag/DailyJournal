...
public class RobotoRegularText extends AppCompatTextView {

    public RobotoRegularText(Context context) {
        super(context);
    ...
    public RobotoRegularText(Context context, AttributeSet attrs, int defStyle) {
